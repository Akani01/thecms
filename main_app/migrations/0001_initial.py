    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.CharField(choices=[('Limpopo', 'Limpopo'), ('Gauteng', 'Gauteng'), ('KwaZulu-Natal', 'KwaZulu-Natal'), ('Western Cape', 'Western Cape'), ('Eastern Cape', 'Eastern Cape'), ('Free State', 'Free State'), ('North West', 'North West'), ('Mpumalanga', 'Mpumalanga'), ('Northern Cape', 'Northern Cape')], max_length=50)),
                ('contact', models.CharField(max_length=255)),
                ('sector', models.CharField(blank=True, max_length=255, null=True)),
                ('educators_on_db', models.IntegerField(default=0)),
                ('principals_on_db', models.IntegerField(default=0)),
                ('staff_on_db', models.IntegerField(default=0)),
                ('learners_on_db', models.IntegerField(default=0)),
                ('department_by', models.CharField(choices=[('Department', 'Department'), ('Province', 'Province'), ('Region', 'Region')], default='Region', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submitted_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('circuit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to='main_app.circuit')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('circuit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.circuit')),
